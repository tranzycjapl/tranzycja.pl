...
1. Co się działo w moim życiu, gdy zacz_ł_m się samookaleczać po raz pierwszy? Czy są jakieś rzeczy z przeszłości, z których zdał_m sobie sprawę w okresie, w którym zacz_ł_m się okaleczać? 
2. Jak konkretnie się samookaleczam? Czy robię to zawsze w określony sposób, w określonym miejscu, po interakcjach z konkretną osobą? Czy są określone dźwięki, zapachy, pory roku i inne rzeczy, które wzmagają moją chęć do samookaleczania się? 
3. Czy moje sposoby na samookaleczanie się ulegały zmianom w czasie? 
4. Jak czuję się bezpośrednio przed samookaleczeniem? A bezpośrednio po? Czy zawsze są to te same emocje?  
5. Co w sposobie, w jaki się samookaleczam, przynosi mi ulgę? Czy jest to zostawienie na sobie śladu, widok krwi, ból? Co z kolei jest negatywne, sprawia, że czuję się gorzej? 
